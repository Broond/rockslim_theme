        ...
        <section class="block">
            <div class="container">
                <div class="columns is-vcentered">
                    ...
                    <div class="column is-4">
                        <div class="content-block">
                            <h1 class="is-size-4">GAMES WE PLAY</h1>
                            <p>Our primary focus is to be one of the top PvP Companies in Amazon Game Studio’s New
                                World,
                                but we can also be found playing other PvP games such as Sea of Thieves, Ark, Rust, and
                                Squad.</p>
                        </div>
                    </div>
                </div>
        ...
        <section class="block">
            <div class="container">
                <div class="columns is-vcentered">
                    <div class="column is-4">
                        <div class="content-block">
                            <h1 class="is-size-4">OUR CONTENT</h1>
                            <p>We are in the process of building up our Twitch and Youtube channels to bring you videos
                                and
                                tutorials. Stay tuned for more information!</p>
                        </div>
                    </div>
                    <div class="column is-8">
                        <div class="image-block">
